...
public class SpawnTriggerThirdRoom: MonoBehaviour
{
    ...
    void SpawnEnemy()
    {
        Instantiate(MiniBossPrefab, SpawnPosition.transform.position, SpawnPosition.transform.rotation);
        ...
        Instantiate(enemyPrefab, SpawnPosition8.transform.position, SpawnPosition8.transform.rotation);
        Destroy(gameObject);
    }
}
